...
import { IDatabaseStrategy, FullTableMetadata, ColumnInfo, IndexInfo } from '../database-strategies';
...
export class MigrationComparisonService {
    ...
    compareColumns(sourceColumns: ColumnInfo[], targetColumns: ColumnInfo[]): MigrationColumnDiff[] {
    ...
    compareIndices(sourceIndices: IndexInfo[], targetIndices: IndexInfo[]): MigrationIndexDiff[] {
    ...
    buildMigrationReviewSummary(context: ResolvedMigrationContext, dto: StartMigrationDto): MigrationReviewSummary {
