...
export type ConnectionType = 'postgres' | 'mysql' | 'mssql' | 'sqlite' | 'clickhouse' | 'mock' | 'mongodb' | 'mongodb+srv';
...
export interface MigrationStream extends AsyncIterable<Record<string, unknown>> {
