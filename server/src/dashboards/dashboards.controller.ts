...
export class DashboardsController {
  ...
  @Post(':id/widgets')
  addWidget(@Param('id') id: string, @Body() dto: AddDashboardWidgetDto, @Req() req: any) {
    return this.dashboardsService.addWidget(id, dto, req.user.id);
  }

  @Delete(':dashboardId/widgets/:widgetId')
  removeWidget(@Param('dashboardId') dashboardId: string, @Param('widgetId') widgetId: string, @Req() req: any) {
