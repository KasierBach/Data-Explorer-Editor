...
export enum AuditAction {
  ...
  // AI Actions
  AI_SQL_GENERATED = 'AI:SQL_GENERATED',
  AI_SQL_GENERATION_FAILED = 'AI:SQL_GENERATION_FAILED',
  AI_SQL_FEEDBACK = 'AI:SQL_FEEDBACK',
  ...
  TEAM_COMMENT_EDIT = 'TEAM:COMMENT_EDIT',
  TEAM_COMMENT_DELETE = 'TEAM:COMMENT_DELETE',
  TEAM_COMMENT_REACTION = 'TEAM:COMMENT_REACTION',
...
export class AuditService {
  ...
  async findOrganizationLogs(
    organizationId: string,
    options: OrganizationLogQueryOptions = {},
  ) {
    return this.prisma.auditLog.findMany({
      where: {
        organizationId,
